...
import lambdas_streams_ajayIyengar.section2.stratergypattern.Designation;
import lambdas_streams_ajayIyengar.section2.stratergypattern.Employee;
import lambdas_streams_ajayIyengar.section2.stratergypattern.Skill;
import lambdas_streams_ajayIyengar.section2.stratergypattern.Unit;
...
public class EmployeeTestLambdasToPredicateRefactor {
	...
	public static void main(String args[]) {
		...
		// combine multiple predicates with predicate functional interface
		List<Employee> javaDevsInEdcUnit = getEmployeesFilteredBy(javasSkillsFilter.and(unitFilter));

		System.out.println("--------Java Developers in EDC--------");
		System.out.println(javaDevsInEdcUnit);
	}
