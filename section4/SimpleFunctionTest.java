...
public class SimpleFunctionTest {
    ...
    public static void main(String[] args) {
        ...
        ToDoubleFunction<List<Customer>> averageAgeFInder = c -> findAvg(c);
        double avg = averageAgeFInder.applyAsDouble(customers);

        System.out.println("\nExample Five : ");
        System.out.println("Input list is : " + customers);
        System.out.println("average age of the customer : " + avg);
    }

    public static double findAvg(List<Customer> c) {
        int total = 0;
        for (Customer cus : c) {
            total += cus.getAge();
        }
