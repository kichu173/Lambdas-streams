...
public class FootballTeam {
	...
	private int goalsFor;// capture the no. of goals that a particular football team has scored against the opponent
	private int goalsAgainst;// capture the no. of goals that the opponent has scored against the given fb team
