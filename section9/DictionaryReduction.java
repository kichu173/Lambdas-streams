package lambdas_streams_ajayIyengar.section9;
...
public class DictionaryReduction {
    ...
    private static final String FILE_PATH = "D:\\Java\\Lambdas-streams\\src\\streams\\ch08\\dictionary.txt";
...
//                    .reduce(0, max) // returns int , alternate to max()
//                    .reduce(0, Integer::max) //  returns int ,alternate to max()
                    .max();

            System.out.println(maxLength.orElseThrow(() -> new NoSuchElementException("No found"))); // 21
        }
    }
